...
import { Input, inputBaseClassName, InputProps } from "@/components/ui/input"
import { Textarea } from "@/components/ui/textarea"
import { INPUT_HEIGHT } from "@/shared/constants/styles"

const inputGroupBaseClassName = cn(
    "min-w-0 has-[>textarea]:h-auto group/input-group border-input dark:bg-input/30 relative flex w-full bg-background-light items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none",
...
function InputGroup({ className, size, variant, ...props }: InputGroupProps) {
    return (
        <div
