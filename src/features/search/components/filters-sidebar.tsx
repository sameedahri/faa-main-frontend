...
function FiltersSidebar() {
    return (
        <div className="overflow-y-auto h-fit max-h-[calc(100vh-var(--height-nav)-8.5rem)] flex flex-col gap-6 p-5 rounded-md bg-background-light sticky top-[calc(var(--height-nav)+2rem)]">
